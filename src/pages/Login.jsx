...
// Animated dot component for the loading indicator
const Dot = ({ delay }) => (
  <motion.div
    style={{
      width: 12,
      ...
      {[...Array(barCount)].map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            margin: '0 2px',
            borderRadius: '2px',
            opacity: 0.6 + (i / barCount) * 0.4 // Vary opacity based on position
          }}
        />
      ))}
    </Box>
...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      {[...Array(8)].map((_, i) => (
        <motion.div
          ...
          animate={{ 
            x: Math.random() * window.innerWidth, 
            y: Math.random() * window.innerHeight,
            opacity: [0.2 + Math.random() * 0.1, 0.3 + Math.random() * 0.1, 0.2 + Math.random() * 0.1]
          }}
          transition={{ 
      ...
      <Container maxWidth="lg" sx={{ height: '100%', py: 4, zIndex: 1, position: 'relative' }}>
        {/* Header */}
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          >
            <Box
              sx={{
                ...
                borderRadius: 6,
                boxShadow: '0 20px 80px rgba(0, 0, 0, 0.1), 0 10px 30px rgba(0, 0, 0, 0.06)',
                mb: 5,
                overflow: 'hidden',
                position: 'relative',
              }}
              ...
              <Box sx={{ position: 'relative', zIndex: 1 }}>
                ...
                <Box sx={{ textAlign: 'center', mb: 5 }}>
                  ...
                  >
                    ...
                    >
                      AI-powered meeting minutes that capture every detail so you never miss what matters.
                    </Typography>
                  </motion.div>
                </Box>
                
                {/* Google Sign-in - PROMINENTLY FEATURED */}
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
          ...
          {/* Feature Cards - Animated on click */}
        ...
        <Box sx={{ textAlign: 'center', mt: 4, pb: 2 }}>
          ...
          >
            <Typography variant="caption" color="text.secondary">
              © {new Date().getFullYear()} MinuteMe | All rights reserved
            </Typography>
          </motion.div>
        </Box>
      </Container>
